   ...
   function onedevs_quienes_somos()
   {
      ...
      <div class="home-section" id="quienes-somos">
         ...
         <div class="wrapper">
            ...
            <p class="content">
               Somos un Grupo de <b>Desarrolladores de Software</b> autónomos apasionados por la Tecnología
            </p>
         ...
         <div class="member mobile">{$vertical_separator}
            ...
            <div class="description">
               <div class="wrapper">
                  ...
                  <br />
                  <span class="collaborator">General Manager</span><br />
                  <span class="collaborator">PHP + MySQL Backend Developer</span><br />
